  ...
  return(
    <div className='projects'>
      ...
      <div className='mainProjects'>
        ...
        <img className='TLimg' src='https://i.gyazo.com/a58e1fdb0a1a097b63abbab19b7741cd.jpg' width={800}/>
        <a href='https://fotobook-dark.netlify.app/'>Fotobook</a>
        <img className='FBimg' src='https://i.gyazo.com/13e2920de1b35e6b31e236490f445bdc.png' width={800}/>
