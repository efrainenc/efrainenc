      ...
      <section id='aboutMe'>
        <div className='aboutMeContainer'>
          ...
          <div className='aboutContent'>
            <p>
              I'm an experienced Software developer with a strong background in customer service and a proven ability to deliver high-quality, innovative applications. 
              Skilled in various programming languages including Python, JavaScript, and Java, as well as popular technologies such as React, Django, Angular, Node.js, and Express. 
