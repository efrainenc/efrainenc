      ...
      <section id='aboutMe'>
        <div className='aboutMeContainer'>
          ...
          <div className='aboutContent'>
            <p>
              I'm an experienced Back-end developer with a strong background in customer service and a proven ability to deliver high-quality, innovative web applications. 
